...
<!-- end Rest of the header -->
        ...
        <div class="header-banner banner-image">
            <div class="banner-wrap">
                ...
                <div class="banner-header" style="background-image: url(images/anne-frank-1920x463.png);min-height:460px;" >
                                            ...
                                            <div class="single-product-media">
                                                <div class="images product-img">
                                                    <a href="#" class="image-feature">
                                                        <img src="images/anne-frank-500x590-1.png" alt="img">
                                                    </a>
                                                </div>
                                                <div class="product-thumbs">
                                                    <a href="#" class="img-product-thumb"><img src="images/anne-frank-100x120-1.png" alt=""></a>
                                                    <a href="#" class="img-product-thumb"><img src="images/anne-frank-100x120-2.png" alt=""></a>
                                                    <a href="#" class="img-product-thumb"><img src="images/anne-frank-100x120-3.png" alt=""></a>
                                                    <a href="#" class="img-product-thumb"><img src="images/anne-frank-100x120-4.png" alt=""></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-7">
                                            <div class="single-product-content">
                                                <h6 class="product-title">Anne Frank Museum</h6>
                                                ...
                                                <form action="inc/cart-update.php" method="post" class="cart">
                                                    <div class="quantity">
                                                        <div class="quantity buttons_added">
                                                            <a href="#" class="sign minus"><i class="fa fa-minus"></i></a>
                                                            <input type="text" value="1" name="product_qty" class="input-text qty text" size="1">
                                                            <a href="#" class="sign plus"><i class="fa fa-plus"></i></a>
                                                        </div>
                                                    </div>
                                                        <input type="hidden" name="product_code" value="<?php echo $product_id; ?>" />
                                    ...
                                    <div id="tab_product" class="tab-product-page">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div role="tabpanel" class="tab-pane active" id="addinformation">
                                                <div class="box-content">
                                                    <p>Het Anne Frank Huis is een monument ter gedachtenis aan Anne Frank en haar familie. Het huis staat in Amsterdam aan de Prinsengracht 263-267.
                                                    </p>
                                                    <span>Adress & info</span>
                                                    <div class="parameter">
                                                        <p>Prinsengracht 263-267</p>
                                                        <p>+31 (0)20 556 7105</p>
