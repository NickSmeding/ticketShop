...
<!-- end Rest of the header -->
        ...
        <div class="header-banner banner-image">
            <div class="banner-wrap">
                ...
                <div class="banner-header" style="background-image: url(images/rijksmuseum-1920x463.png);min-height:460px;" >
                                            ...
                                            <div class="single-product-media">
                                                <div class="images product-img">
                                                    <a href="#" class="image-feature">
                                                        <img src="images/rijksmuseum-500x590-2.png" alt="img">
                                                    </a>
                                                </div>
                                                <div class="product-thumbs">
                                                    <a href="#" class="img-product-thumb"><img src="images/rijksmuseum-100x120-1.png" alt=""></a>
                                                    <a href="#" class="img-product-thumb"><img src="images/rijksmuseum-100x120-2.png" alt=""></a>
                                                    <a href="#" class="img-product-thumb"><img src="images/rijksmuseum-100x120-3.png" alt=""></a>
                                                    <a href="#" class="img-product-thumb"><img src="images/rijksmuseum-100x120-4.png" alt=""></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-7">
                                            <div class="single-product-content">
                                                <h6 class="product-title">Van Gogh Musea</h6>
                                        ...
                                        <div class="tab-content">
                                            <div role="tabpanel" class="tab-pane " id="description">
                                                <div class="box-content">
                                                  <p>At the Rijksmuseum, art and history take on new meaning for a broad-based, contemporary national and international audience.</p>

                                                  <p>As a national institute, the Rijksmuseum offers a representative overview of Dutch art and history from the Middle Ages onwards, and of major aspects of European and Asian art.</p>

                                                  <p>The Rijksmuseum keeps, manages, conserves, restores, researches, prepares, collects, publishes, and presents artistic and historical objects, both on its own premises and elsewhere.</p>
                                                </div>
                                            </div>
                                            <div role="tabpanel" class="tab-pane active" id="addinformation">
                                                <div class="box-content">
                                                    ...
                                                    <div class="parameter">
                                                        ...
                                                        <p>Telefoonnummer: +31 (0) 20 6747 000</p>
                                                    </div>
                                                </div>
                                            </div>
