...
<!-- end Rest of the header -->
        ...
        <div class="header-banner banner-image">
            <div class="banner-wrap">
                ...
                <div class="banner-header" style="background-image: url(images/rondvaart-amsterdam-1920x463.png);min-height:460px;" >
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="single-product-media">
                                                <div class="images product-img">
                                                    <a href="#" class="image-feature">
                                                        <img src="images/rondvaart-amsterdam-500x590-3.png" alt="img">
                                                    </a>
                                                </div>
                                                <div class="product-thumbs">
                                                    <a href="#" class="img-product-thumb"><img src="images/rondvaart-amsterdam-100x120-1.png" alt=""></a>
                                                    <a href="#" class="img-product-thumb"><img src="images/rondvaart-amsterdam-100x120-2.png" alt=""></a>
                                                    <a href="#" class="img-product-thumb"><img src="images/rondvaart-amsterdam-100x120-3.png" alt=""></a>
                                                    <a href="#" class="img-product-thumb"><img src="images/rondvaart-amsterdam-100x120-1.png" alt=""></a>
                                                    <a href="#" class="img-product-thumb"><img src="images/rondvaart-amsterdam-100x120-2.png" alt=""></a>
                                                    <a href="#" class="img-product-thumb"><img src="images/rondvaart-amsterdam-100x120-3.png" alt=""></a>
                                                </div>
                                        ...
                                        <div class="col-sm-7">
                                            <div class="single-product-content">
                                                <h6 class="product-title">Rondvaart Amsterdam</h6>
                                                ...
                                                <div class="product-desc">
                                                    Amsterdam is sometimes referred to as 'Venice of the North'. 100 km of canals divide the city into smaller islands, connected by beautiful historic bridges.
                                                </div>
                                        ...
                                        <div class="tab-content">
                                            <div role="tabpanel" class="tab-pane " id="description">
                                                <div class="box-content">
                                                    <p>Amsterdam is sometimes referred to as 'Venice of the North'. 100 km of canals divide the city into smaller islands, connected by beautiful historic bridges. The most famous canals are the Herengracht, Keizersgracht and Prinsengracht. This cruise takes you through the unique UNESCO World Heritage canal district. You will be able to admire the elegant merchants’ houses that have lined the canals since the Golden Age, the majestic façades and gables, beautiful churches, the iconic “Magere Brug” (Skinny Bridge) and many more highlights.
                                                    </p>
                                                    <p>During the cruise we offer a commentary in 18 languages. Your visit to Amsterdam is only complete when you have experienced the city from the water.</p>
                                                </div>
                                            </div>
                                            <div role="tabpanel" class="tab-pane active" id="addinformation">
                                                <div class="box-content">
                                                    <p>Amsterdam is sometimes referred to as 'Venice of the North'. 100 km of canals divide the city into smaller islands, connected by beautiful historic bridges.</p>
                                                    <span>Adress & info</span>
                                                    <div class="parameter">
                                                      <p>Departures: </p>
                                                      <p>Summer season (March 23 - October 30): </p>
                                                      <p>Daily frequent departures from 09.00 - 22.00 h. </p>
                                                      <p> </p>
                                                      <p>Winter season (October 31 - March 22): </p>
                                                      <p>Daily frequent departures from 09.30 - 21.00 h. </p>
                                                      <p> </p>
                                                      <p>Duration: ± 1 h. </p>
                                                      <p> </p>
                                                      <p>Check-in: 30 min. before departure at Prins Hendrikkade 25 </p>
                                                    </div>
                                                </div>
                                            </div>
