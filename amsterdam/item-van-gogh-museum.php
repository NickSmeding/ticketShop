...
<!-- end Rest of the header -->
        ...
        <div class="header-banner banner-image">
            <div class="banner-wrap">
                ...
                <div class="banner-header" style="background-image: url(images/vangogh-1920x463.png);min-height:460px;" >
                                            ...
                                            <div class="single-product-media">
                                                <div class="images product-img">
                                                    <a href="#" class="image-feature">
                                                        <img src="images/vangogh-500x590-1.png" alt="img">
                                                    </a>
                                                </div>
                                                <div class="product-thumbs">
                                                    <a href="#" class="img-product-thumb"><img src="images/vangogh-100x120-1.png" alt=""></a>
                                                    <a href="#" class="img-product-thumb"><img src="images/vangogh-100x120-2.png" alt=""></a>
                                                    <a href="#" class="img-product-thumb"><img src="images/vangogh-100x120-3.png" alt=""></a>
                                                    <a href="#" class="img-product-thumb"><img src="images/vangogh-100x120-1.png" alt=""></a>
                                                    <a href="#" class="img-product-thumb"><img src="images/vangogh-100x120-2.png" alt=""></a>
                                                    <a href="#" class="img-product-thumb"><img src="images/vangogh-100x120-3.png" alt=""></a>
                                                </div>
                                        ...
                                        <div class="col-sm-7">
                                            <div class="single-product-content">
                                                ...
                                                <div class="product-desc">
                                                    The Van Gogh Museum is located at the Museumplein in Amsterdam. Getting to the museum is easy by public transport, bicycle, car or coach.
                                                </div>
                                        ...
                                        <div class="tab-content">
                                            <div role="tabpanel" class="tab-pane " id="description">
                                                <div class="box-content">
                                                    <p>Mission:<P>
                                                    <p>The Van Gogh Museum formulated the following mission statement.</p>
                                                    <p>The Van Gogh Museum makes the life and work of Vincent van Gogh and the art of his time accessible to as many people as possible in order to enrich and inspire them.</p>
                                                </div>
                                            </div>
